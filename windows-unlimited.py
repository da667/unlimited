...
count: number of events before triggering event_limit type
...
parser.add_argument('-i', dest="infile", required=True, help="The name of the file containing the comma-delimited data for generating event_filters.")
...
print "[*] Using %s as input file.." %args.infile
print "[*] And %s as output file..." %args.outfile
